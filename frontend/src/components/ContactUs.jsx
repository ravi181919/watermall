...
const ContactUs = () => {
  return (
    <div className="dark:bg-black/85 relative w-full drop-shadow-md bg-white/85 dark:text-white/85 text-black/85  lg:w-full  flex flex-col justify-center items-center ">
      <Navbar />
      ...
      <div className="mt-8 flex items-center justify-center flex-col w-full h-full">
        <h1 className="text-3xl leading-none font-black pt-14">Contact Us</h1>
        <p className="text-xs leading-none pt-2 pb-2 text-center max-w-xl">
          Have any questions or need help? Feel free to reach out to us using
          the form below
        </p>
        <form className=" shadow-md dark:shadow-black/20 shadow-black/20 rounded-lg p-6 w-full max-w-sm">
          ...
          <div className="mb-4">
            ...
            <textarea
              id="message"
              rows="2"
              className="mt-1 w-full bg-transparent p-2 placeholder:text-black/85 dark:placeholder:text-white/85 border dark:border-zinc-100 border-zinc-700 rounded-md focus:outline-none focus:ring-1 focus:ring-red-600"
