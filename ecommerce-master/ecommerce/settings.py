...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework.authentication.SessionAuthentication',  # Optional for Session-based
        # 'rest_framework_simplejwt.authentication.JWTAuthentication',  # Optional for JWT
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Require user to be authenticated
    ],
}
